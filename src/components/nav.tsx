                        ...
                        <ul className="navbar-nav ml-auto mr-xl-2 " >
                          <li className="m-auto ">
                            ...
                            <li className="m-auto text-center">
                              <button className='nav-link btn2 btn-primary text-center px-4 py-2 mx-3 text-white' style={{fontSize: '18px',textOverflow: 'initial'}} id='connect_button'>Wallet Connect</button>
                            </li>
